...
public class ProvisionServiceVO extends CommonServiceVO {
	...
	public ProvisionServiceVO() {
		super();
	}

	public ProvisionServiceVO(String logMasterId, String logDetailId, String logStepId, String logRetryId,
			String logDeviceId, String result, String message, Date beginTime, Date endTime, Integer spendTimeInSeconds,
			String remark, String userName, String userIp, String scriptCode, Integer retryTimes, String processLog,
			Integer orderNum, String deviceListId, Integer retryOrder, List<ProvisionServiceVO> detailVO,
			List<ProvisionServiceVO> stepVO, List<ProvisionServiceVO> retryVO, List<ProvisionServiceVO> deviceVO) {
		super();
