...
public class ScriptController extends BaseController {
	...
	private static final String[] UI_TABLE_COLUMNS = new String[] {"","","si.scriptName","si.scriptType.scriptTypeCode","si.systemVersion","si.actionScript","si.actionScriptRemark","si.checkScript","si.checkScriptRemark","si.createTime","si.updateTime"};
	...
	public @ResponseBody DatatableResponse findScriptData(
		...
		try {
			...
			ssVO.setOrderColumn(UI_TABLE_COLUMNS[orderColIdx]);
