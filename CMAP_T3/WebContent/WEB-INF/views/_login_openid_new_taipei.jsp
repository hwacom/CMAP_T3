            ...
            <div class="col-12">
			  	...
			  	<div class="row">
			  		<div class="col-md-6 col-sm-12 offset-md-3 m-t-5 login-form">
						  ...
						  <div class="col-12">
						  	<img src="${pageContext.request.contextPath}/resources/images/openid_new_taipei.png" style="float: left; margin: 15px; width: 64px; height: auto;"/>
							<p style="text-align: left;">本系統採用新北市教育局公開認證服務<br>按下登入後將導向該登入頁面</p>
			  			  </div>
			  			</div>
			  			<div class="row offset-md-1">
